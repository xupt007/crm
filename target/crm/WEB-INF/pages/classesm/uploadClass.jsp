...
<%-- <s:form namespace="/classesm" action="classAction_upload" enctype="multipart/form-data">
...
<form action="<%=basePath %>uploadSchedule" enctype="multipart/form-data" method="post">
	<input type="hidden" name="classid" value="${classCustom.classid }"/>
	<table width="88%" border="0" class="emp_table" style="width:80%;">
	  <tr>
	    <td width="120">课程类别：</td>
	    <td>${classCustom.courseName }</td>
	    <td>&nbsp;</td>
	  </tr>
	  <tr>
	    <td>班级：</td>
	    <td>${classCustom.name }</td>
	    <td>&nbsp;</td>
	  </tr>
	  <tr>
	    <td>上次上传时间：</td>
	    <td><fmt:formatDate value="${classCustom.uploadtime }" pattern="yyyy-MM-dd"/></td>
	    <td>&nbsp;</td>
	  </tr>
	  <tr>
	    <td>选择课表：</td>
