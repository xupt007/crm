  ...
  <tr class="henglan" style="font-weight:bold;">
	...
	<td width="8%" align="center">录入学籍</td>
			...
			<tr
				...
				<!-- 跟踪 -->
				<td>
					<a href="<%=basePath %>queryBeforeInsertFollow?referid=${refer.referid}">
						<img src="${pageContext.request.contextPath}/images/button/new.gif" class="img"/>
					</a>
				</td>
				<!-- 入学 -->
				<td>
					<a href="<%=basePath%>queryBeforeRegisterStudent?referid=${refer.referid}">
						<img src="${pageContext.request.contextPath}/images/button/modify.gif" class="img"/>
					</a>
				</td>
				</c:if>
...
<table border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td align="right">
        ...
        <span>
        	<a href="referList?currentPage=${page.firstPage }">[首页]</a>&nbsp;&nbsp;
        	<c:if test="${page.pageNum >1 }">
        		<a href="referList?currentPage=${page.prePage }">[上一页]</a>&nbsp;&nbsp;
        	</c:if>
        	<c:if test="${page.pageNum <page.pages }">
        		<a href="referList?currentPage=${page.nextPage }">[下一页]</a>&nbsp;&nbsp;
        	</c:if>
            <a href="referList?currentPage=${page.pages }">[尾页]</a>
        </span>
    </td>
  </tr>
</table>
